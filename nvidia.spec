...
%post kmod-common
sed -i 's/GRUB_CMDLINE_LINUX_DEFAULT="/GRUB_CMDLINE_LINUX_DEFAULT="rd.driver.blacklist=nouveau nvidia-drm.modeset=1 /' %{_sysconfdir}/default/grub
/sbin/depmod -a
/usr/bin/dracut -f
%{_sbindir}/update-grub2

%postun kmod-common
sed -i 's/rd.driver.blacklist=nouveau nvidia-drm.modeset=1 //g' %{_sysconfdir}/default/grub
/sbin/depmod -a
/usr/bin/dracut -f
%{_sbindir}/update-grub2
